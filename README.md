...
- If you want to compute a general Classifier Score with probabilities `preds` from another classifier, call `preds2score(preds, splits=10)`, where `preds` is a numpy array of arbitrary shape `[N, num_classes]`.
## Links
